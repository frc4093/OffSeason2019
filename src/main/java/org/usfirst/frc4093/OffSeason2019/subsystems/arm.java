...
/*
 *Stuff that still needs to get done here
 * bounce feature
 * potentially disable limit override
*/
...
public class arm extends Subsystem {
    ...
    public int lastLimitRecorded = 0; //last switch hit
    public int recordedDir = 1; //current dir of arm
    public int currentDir = 1; //dir when past middle switch

    // limits you can edit with set commands
    private int topLimit = 3; //top switch
    private int midLimit = 2; //middle switch
    private int bottomLimit = 1; //bottom switch
    public arm() {
